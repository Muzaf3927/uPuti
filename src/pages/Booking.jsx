    ...
    <>
      <Tabs defaultValue="fromMe" className="">
        <TabsList className="w-full">
          <TabsTrigger value="fromMe">Yo'lovchi</TabsTrigger>
          <TabsTrigger value="toMe">Haydovchi</TabsTrigger>
        </TabsList>
        ...
        <TabsContent value="toMe">Change your password here.</TabsContent>
      </Tabs>
    </>
  );
}
